...
@Entity
@Table(name = LancheTarde.TABLE_NAME)

public class LancheTarde{
    public static final String TABLE_NAME  = "LancheTarde";
    ...
    public LancheTarde(Integer id, Dieta dieta, String alimentos, Integer calorias) {
        this.id = id;
        this.dieta = dieta;
    ...
    public boolean equals(Object obj) {
        ...
        if (! (obj instanceof LancheTarde))
            return false;
        
        LancheTarde other = (LancheTarde) obj;
        if (this.id != null)
            return false;

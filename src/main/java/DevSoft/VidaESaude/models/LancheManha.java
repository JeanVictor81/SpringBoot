...
@Entity
@Table(name = LancheManha.TABLE_NAME)

public class LancheManha{
    public static final String TABLE_NAME  = "LancheManha";
    ...
    public LancheManha(Integer id, Dieta dieta, String alimentos, Integer calorias) {
        this.id = id;
        this.dieta = dieta;
    ...
    public boolean equals(Object obj) {
        ...
        if (! (obj instanceof LancheManha))
            return false;
        
        LancheManha other = (LancheManha) obj;
        if (this.id != null)
            return false;

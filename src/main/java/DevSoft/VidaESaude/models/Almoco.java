...
@Entity
@Table(name = Almoco.TABLE_NAME)

public class Almoco{
    public static final String TABLE_NAME  = "Almoco";
    ...
    public Almoco(Integer id, Dieta dieta, String alimentos, Integer calorias) {
        this.id = id;
        this.dieta = dieta;
    ...
    public boolean equals(Object obj) {
        ...
        if (! (obj instanceof Almoco))
            return false;
        
        Almoco other = (Almoco) obj;
        if (this.id != null)
            return false;

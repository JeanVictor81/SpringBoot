...
@Entity
@Table(name = CafeManha.TABLE_NAME)

public class CafeManha{
    public static final String TABLE_NAME  = "CafeManha";
    ...
    public CafeManha(Integer id, Dieta dieta, String alimentos, Integer calorias) {
        this.id = id;
        this.dieta = dieta;
